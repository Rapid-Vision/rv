...
| Name | Type | Description |
| - | - | - |
| `resolution` | `tuple[int, int]` | Output image resolution (width, height) |
| `time_limit` | `float` | Per-frame render time limit in seconds |
| `passes` | `set[RenderPass]` | Enabled auxiliary render passes |
...
| Name | Type | Description |
| - | - | - |
| `color` | `tuple[float, float, float, float]` | Environment RGBA color |
